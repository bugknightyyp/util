;define(function(require,exports,module){
  ...
  */
  exports.throttle = function(fn, delay, context){
	...
	*/
	exports.ie = (function(){// gte IE10 返回的是 undefined，估计已经不支持这种条件表达式了;
			var undef,
				v = 5,
  ...
  exports.filterURI = function(URI, oStr) {//"http://lvyou.mangocity.com/search.shtml?search=0&word=a&type=2", {word:"sss",name:"b"}
  ...
  exports.getURIParam = function(URI, str) {//"http://lvyou.mangocity.com/search.shtml?search=0&word=a&type=2", "word"
